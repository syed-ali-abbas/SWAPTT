...
urlpatterns = [
    ...
    path("webapp/subdomainTakeover",views.subdomainTakeover,name="subdomainTakeover"),
    path("webapp/corsy",views.corsy,name="corsy"),
    path("webapp/xss",views.XSS,name="xss"),
    path("webapp/SQLInjection",views.SQLInjection,name="sqli"),
    # <str:filepath>/
]
